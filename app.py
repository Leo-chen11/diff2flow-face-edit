...
st.session_state['edit_strength'] = st.sidebar.slider('Edit strength (0-1) :', min_value=0.,max_value=1., value=0.6,step=0.05)
...
if image_path is None:
    ...
    with st.spinner("Working.. 💫"):
        ...
        transformer = SDFlow(ckpt_dir=args.ckpt_dir, attr_num=attr_num,scale=st.session_state['edit_strength'],device='cuda')
