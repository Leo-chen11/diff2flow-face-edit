...
def _build_direction_bank_safety_controls(args, num_layers=18):
    per_attr_direction_scale = []
    per_attr_delta_max_norm = []
    per_attr_layer_scale = []
    for attr_abs_idx in args.attribute_index:
...
def load_models(args):
    ...
    if bank_path:
        ...
        ) = _build_direction_bank_safety_controls(args, num_layers=18)
