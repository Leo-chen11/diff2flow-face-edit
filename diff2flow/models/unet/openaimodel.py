...
try:
    ...
    from .util import zero_module, normalization, timestep_embedding
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        print(f'[OpenAIUNet] Creating Model')
        ...
        if load_from_ckpt is not None:
            print(f'[OpenAIUNet] Loading checkpoint from {load_from_ckpt}')
    ...
    def forward(self, x, t=None, context=None, context_ca=None, y=None, **kwargs):
        ...
        h = x.type(self.dtype)
        if context is not None and self.concat_context:
...
if __name__ == "__main__":
    unet = UNetModel(
        load_from_ckpt="/export/home/ru59wap/projects/depth-fm-v2/checkpoints/v2-1_768-ema-pruned.ckpt"
    )
