...
class EMA(Module):
    ...
    # adaptations for flow matching
    def decode(self, *args, **kwargs):
        return self.ema_model.decode(*args, **kwargs)
    
    def encode(self, *args, **kwargs):
        return self.ema_model.encode(*args, **kwargs)
    
    def generate(self, *args, **kwargs):
        return self.ema_model.generate(*args, **kwargs)
